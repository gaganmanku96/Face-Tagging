...
def face_encodings(face_image, known_face_locations=None, num_jitters=1):
    ...
    return [list(face_encoder.compute_face_descriptor(face_image, raw_landmark_set, num_jitters)) for raw_landmark_set in raw_landmarks]
...
def get_encoding(image, encode_to_string=False, type='path'):
    if type == 'image':
